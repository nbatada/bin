...
def _setup_arg_parser():
    ...
    p_compare_within = subparsers.add_parser("compare_within", help="Compare columns/rows within a single table.", formatter_class=CommandGroupHelpFormatter)
    p_compare_between = subparsers.add_parser("compare_between", help="Compare columns between two tables.", formatter_class=CommandGroupHelpFormatter)
...
def main():
    ...
    is_standalone_command = (args.group == 'compare_between' and args.action in ['inspect', 'pairwise-similarity', 'venn'])
